...
❗️ Replace `nyarachun` with your Github username and copy the links to `Pull Request` description:

- [DEMO LINK](https://nyarachun.github.io/layout_search-bar-airbnb/)
- [TEST REPORT LINK](https://nyarachun.github.io/layout_search-bar-airbnb/report/html_report/)
